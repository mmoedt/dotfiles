...
(load-library "~/.emacs.d/highlight-chars.el")
...
(when (locate-library "~/.emacs.d/javascript")
    (autoload 'javascript-mode "~/.emacs.d/javascript" nil t)
...
;; Needed .el files are in ~/.emacs.d.  (e.g. highlight-chars)
;;(add-to-list 'load-path "~/.emacs.d")  ;; disabled -doesn't seem to work

;; emacs24 way: (load-theme 'solarized-dark t)
;;   see hook at the end of this file
;;
...
;;;; Below is pre-checktyle-tweaking, found on old-workplace wiki:
;; (c-add-style "old-work-c"
;;              '((c-basic-offset . 4)
...
(setq c-default-style "old-work-c")

(add-hook 'java-mode-hook (lambda ()
                            (setq c-basic-offset 2
                                  tab-width 8
                                  indent-tabs-mode nil)))
;; Commented out the below.  It looks like old-work uses width of '2' (yeah, I know)
;;(add-hook 'java-mode-hook (lambda ()
;;                            (setq c-basic-offset 4
;;                                  tab-width 8
;;                                  indent-tabs-mode nil)))

;; Alternate code block, from http://wiki/moin/Old-WorkCEmacsMode:
;;
